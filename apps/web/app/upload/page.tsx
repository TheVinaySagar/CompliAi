...
export default function UploadPage() {
  ...
  const loadDocuments = async () => {
    try {
      ...
      console.error(
        "Exception occurred while loading documents:",
        error?.message || error
      );
      setUploadedFiles([]);
    } finally {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        const newFile: UploadedFile = {
          ...
          status:
            response.data.status === "success" ? "Completed" : "Processing",
        };
    ...
    <div className="p-4 sm:p-6">
      <div className="mb-6 sm:mb-8">
        ...
        <p className="text-sm sm:text-base text-muted-foreground">
          Upload your policy documents to extract and map compliance controls
        </p>
      </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-2 sm:ml-3">
              <p className="text-xs sm:text-sm font-medium text-emerald-800 dark:text-emerald-200">
                Document uploaded successfully! Policies extracted and controls
                mapped.
              </p>
            </div>
          </div>
            ...
            {isUploading ? (
              <div className="flex flex-col items-center">
                ...
                <div className="mt-2 sm:mt-4">
                  <span className="block text-sm sm:text-sm font-medium text-foreground">
                    Uploading and processing...
                  </span>
                  <span className="block text-sm sm:text-sm text-muted-foreground">
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="text-sm font-medium text-card-foreground break-all mb-2">
                          {file.name}
                        </h3>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="text-sm font-medium text-card-foreground break-all">
                            {file.name}
                          </div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <button
                        ...
                        title={
                          file.status === "Completed"
                            ? "View Mapping"
                            : "Mapping available after processing"
                        }
                      >
