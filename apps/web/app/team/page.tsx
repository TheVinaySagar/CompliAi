          ...
          {isLoading ? (
            <div className="space-y-3 sm:space-y-4">
              {[1, 2, 3, 4, 5].map((i) => (
                <div
                  key={i}
                  className="flex items-center p-3 sm:p-4 border border-gray-200 rounded-lg animate-pulse"
                >
                ...
                >
                  <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs sm:text-sm text-gray-500 break-all truncate">
                        {member.email}
                      </p>
                      {member.department && (
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 ml-0 sm:ml-4 w-full sm:w-auto">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-1 sm:gap-2 w-full sm:w-auto">
                      <div className="flex items-center flex-wrap">
                        <Calendar className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-gray-500 mr-1 flex-shrink-0" />
                      ...
                      {member.last_login && (
                        <div className="flex items-center flex-wrap">
                          <span className="hidden sm:inline text-gray-300 mx-1">
                            •
                          </span>
