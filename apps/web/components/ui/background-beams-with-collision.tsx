...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    ...
    >
      ...
      <div
        ref={containerRef}
        // make the bottom overlay transparent so it doesn't override page background
  ...
  return (
    <>
      <motion.div
        ...
        animate="animate"
        initial={{
          // use viewport units so the beams start above the viewport on large screens
        ...
        variants={{
          animate: {
            // translate far below the viewport so beams always reach the bottom on tall screens
