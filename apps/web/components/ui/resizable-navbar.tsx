    ...
    <motion.div
      animate={{
        ...
        boxShadow: visible
          ...
          : "0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06)",
        paddingLeft: visible ? "2rem" : "1.5rem",
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-full flex-row items-center justify-between self-start lg:flex",
        className
      )}
    >
      {children}
  ...
  return (
    <motion.div
      animate={{
        ...
        paddingTop: visible ? "0.75rem" : "0.875rem",
        paddingBottom: visible ? "0.75rem" : "0.875rem",
      }}
      transition={{
        type: "spring",
        stiffness: 200,
